...
class STSSM_Admin_Menu {
	...
	public static function create_menu() {
		$settings = add_options_page( esc_html__( 'Share Social Media', 'share-social-media' ), esc_html__( 'Social Share', 'share-social-media' ), 'manage_options', 'stssm_settings', array( 'STSSM_Admin_Menu', 'settings' ) );
