			...
			<div x-bind="fields">
				...
				<div x-data="fixFlick( <?php echo esc_attr( $front['fix_flick'] ? 'true' : 'false' ); ?> )">
					...
					<div class="dmt-form-control dmt-mb-3" x-bind="fields">
						...
						<input name="flick_bg_color" type="text" id="dmt-btn_color_dark" class="dmt-color-picker" value="<?php echo esc_attr( $front['flick_bg_color'] ); ?>" data-default-color="<?php echo esc_attr( $default_front['flick_bg_color'] ); ?>">
