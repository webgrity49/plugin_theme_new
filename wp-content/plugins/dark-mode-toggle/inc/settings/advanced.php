	...
	<div class="md:dmt-grid md:dmt-grid-cols-2 xl:dmt-grid-cols-3 md:dmt-gap-x-10 lg:dmt-gap-x-12 dmt-px-1">
		<div class="dmt-max-w-sm">
			...
			<div class="dmt-form-control dmt-mb-3">
				...
				<label class="dmt-label">
					<span class="dmt-label-text-alt"><?php echo wp_kses( __( 'Set transition time in seconds.<br>Set it to a positive value like 0.5 to create a transition effect.', 'dark-mode-toggle' ), array( 'br' => array() ) ); ?></span>
		...
		<div class="dmt-max-w-sm">
			...
			<div class="dmt-form-control dmt-mb-3" x-data="override( <?php echo esc_attr( $advanced['front']['override'] ? 'true' : 'false' ); ?> )">
				...
				<div class="dmt-label-text-alt dmt-px-1 and dmt-py-2" x-bind="fields">
			...
			<div class="dmt-form-control dmt-mb-3">
				...
				<div class="dmt-label-text-alt dmt-px-1 and dmt-py-2">
					<?php
					printf(
						wp_kses(
